...
def explore_data():
    ...
    print(f"{restaurant_1['latitude']} {restaurant_1['longitude']}")
    # print(f"Latitude: {restaurant_1['latitude']}, Longitude: {restaurant_1['longitude']}")
...
#     # etc etc
    ...
    # restaurant_1_items = restaurant_1.items()
